...
// imported react icons from react-icons 
        ...
        <div className="searchDiv grid gap-10 bg-greyIsh rounded-[10px] p-[3rem]">
            <form action="">
                <div className="firstDiv flex justify-between items-center rounded-[8px] gap-[10px] bg-white p-5 shadow-lg shadow-greyIsh-700">
                    ...
                    <button className='bg-blueColor h-full p-4 px-10 rounded-[10px] text-white hover:bg-slate-700'>Search</button>
                </div>
            ...
            <div className="secDiv flex items-center gap-10 justify-center">
                ...
                <div className="singleSearch flex items-center gap-2">
                    <label htmlFor="type" className='text-[#808080] font-semibold'>Type of:</label>
